          ...
          <>
            ...
            <Collapse in={leaguesOpen} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                {state.selectedLeagues.map((league) => (
                  <ListItem key={league.id} sx={{ pl: 4 }} disablePadding>
                    <ListItemButton>
                      <ListItemIcon sx={{ minWidth: 36 }}>
                        {league.sport === 'football' && <SportsFootball fontSize="small" />}
                        {league.sport === 'soccer' && <SportsSoccer fontSize="small" />}
                        {league.sport === 'basketball' && <SportsBasketball fontSize="small" />}
                        {!['football', 'soccer', 'basketball'].includes(league.sport) && <Sports fontSize="small" />}
                      </ListItemIcon>
                      <ListItemText 
                        primary={league.name}
